...
http.createServer(async(req,res)=>{
 ...
 if(!target.startsWith(root+path.sep)||!['.html','.css','.js'].includes(path.extname(target))){res.writeHead(404).end();return;}
...
}).listen(Number(process.env.PORT)||3002,'127.0.0.1',()=>console.log('Media analytics: http://127.0.0.1:'+(process.env.PORT||3002)));
